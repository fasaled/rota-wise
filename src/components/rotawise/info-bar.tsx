  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {message.description && (
          <p className="mt-0.5 leading-snug opacity-80 text-xs">
            {message.description}
          </p>
        )}
      </div>
...
export function InfoBarList({ messages, onDismiss }: InfoBarListProps) {
  ...
  return (
    <div
      className="fixed top-6 right-4 z-[100] flex flex-col gap-3 w-full max-w-sm pointer-events-none items-end"
      aria-live="polite"
      aria-atomic="false"
    >
      {messages.map((msg) => (
