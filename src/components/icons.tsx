...
import { Plane, Star, Briefcase, CalendarDays, Users, Settings, CalendarX, Clock3, CalendarCheck, Ban } from 'lucide-react';
...
export const ThemeIcon = (props: React.ComponentProps<typeof CalendarCheck>) => <CalendarCheck {...props} />;
...
export const ExcludedIcon = (props: React.ComponentProps<typeof Ban>) => <Ban {...props} />;
